        ...
        <div class="space-y-6">
          ...
          <div class="bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg p-6 sm:p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      return (
                        <div key={idx} class="flex items-center justify-between">
                          <div class="flex items-center gap-2">
                            <div class="w-3 h-3 rounded-full border border-[#2a2a2a]" style={`background-color: ${item.color}`}></div>
              ...
              <div class="bg-[#0d0d0d] border border-[#2a2a2a] rounded-lg p-6">
                <h3 class="text-lg font-bold text-white mb-4">Tipos de Exames</h3>
                <div class="space-y-3">
                  {dashboardData.tiposExames.map((item, idx) => {
                    ...
                    return (
                      <div key={idx}>
                        ...
                        <div class="w-full bg-[#1a1a1a] rounded-full h-4 overflow-hidden">
                          <div
