...
import { GridIcon, ListIcon, MonitorIcon, EnvelopeIcon, DollarIcon, TruckIcon, AlertTriangleIcon, GraduationCapIcon, CheckCircleIcon } from "../../components/shared/Icons.tsx";
            ...
            {menuItems.map((item) => {
              ...
              return (
                <a
                  ...
                  class="bg-gray-50 border border-gray-200 rounded-xl p-8 hover:bg-white hover:shadow-md transition-all flex items-center gap-5 group"
                >
